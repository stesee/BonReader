...
const chromeParameter = `--use-file-for-fake-video-capture=${pathToCamFakeStream}`;
  ...
  projects: [
    {
      ...
      use: {
        ...
        launchOptions: {
          args: ["--use-fake-device-for-media-stream", "--use-fake-ui-for-media-stream", chromeParameter],
        },
